        ...
        <div class="container mt-4">
            <div class="button-container">
                <select class="custom-select" id="modalSelect">
                    ...
                    <option value="#generarReporteHardware">Descargar Reporte Del Hardware En Formato Excel </option>
                </select>
            </div>
        </div>
    ...
    <div class="container mt-4">
        <table class="table table-bordered">
            ...
            <tbody>
                <?php while ($row = mysqli_fetch_array($query)): ?>
                    <tr>
                        ...
                        <td class="acciones-column">
                            ...
                            <form action="./controller/InsertarInformacionController.php" method="post" class="btn-group">
                                <input type="hidden" name="codigo_equipo" value="<?= htmlspecialchars($row['codigo_equipo']) ?>">
                                <input type="text" name="descripcion" placeholder="Descripción" required class="form-control">
                                <button type="submit" class="btn btn-primary btn-sm">Enviar</button>
                            </form>

                            <!-- Botón modal para Reportar Daño -->
                            <button type="button" class="btn btn-success btn-sm mt-1" data-toggle="modal" data-target="#modalReportarDanio" data-codigo="<?= htmlspecialchars($row['codigo_equipo']) ?>">Reportar Daño</button>


                <!-- Modal para consultar el estado del equipo -->
                <div class="modal fade" id="modalVerEstado" tabindex="-1" role="dialog" aria-labelledby="modalVerEstadoLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="modalVerEstadoLabel">Estado del Equipo</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                        ...
                        $('.ver-estado-btn').click(function() {
                            ...
                            $.ajax({
                                ...
                                error: function(xhr, status, error) {
                                    console.error(error);
                                    alert('Error al cargar el estado del equipo.');
                                }
                            });
                        });
                    });
                ...
                <div class="modal fade" id="modalReportarDanio" tabindex="-1" role="dialog" aria-labelledby="modalReportarDanioLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <div class="modal-body">
                                <form action="./controller/reporte_danio.php" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="descripcionDanio" name="falla" rows="3" required></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label for="descripcionDanio">Descripcion del Modelo:</label>
                                        <textarea class="form-control" id="descripcionDanio" name="modelo" rows="3" required></textarea>
                                    </div>
                            ...
                            <div class="modal-body">
                                <form action="./controller/ver_estado.php" method="post">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="codigoEstado" name="codigo_equipo" readonly>
                                    </div>
                                    <div class="form-group">
                                        <label for="puertoEstado">Puerto:</label>
                                        <input type="text" class="form-control" id="puertoEstado" name="puerto" required>
                                    </div>
             ...
             <!-- Modal para descargar Excel equipo -->
        <div class="modal fade" id="generarReporteHardware" tabindex="-1" role="dialog" aria-labelledby="generarReporteHardware" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
