...
<header>
    ...
    <body>
        ...
        <div class="modal fade" id="subirRegistros" tabindex="-1" role="dialog" aria-labelledby="subirRegistrosLabel"
            aria-hidden="true">
        ...
        <div class="modal fade" id="subirRegistros" tabindex="-1" role="dialog" aria-labelledby="subirRegistrosLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <a href="../app/Exports/CPUINFO.py" download="CPUINFO.py" class="btn btn-success">Registro
                            Automático</a>
                        <button type=."button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
                    </div>
                </div>
        ...
        <div class="modal fade" id="generarExcel" tabindex="-1" role="dialog" aria-labelledby="generarExcelLabel"
            aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="equipoForm">
                            ...
                            <button type="button" class="btn btn-primary" onclick="descargarExcelEquipo()">Consultar
                                Equipo</button>
                        </form>
                    </div>
                </div>
